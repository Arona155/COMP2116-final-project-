...
|:---------------|:------------------------------------------|:-------------------------------------------------------------------------------------------------------------------|:--------------|
| LAM CHON HIN A (You) | Lead Software Architect & Project Manager | Project initialization, software evolution (Focus/Health Mode), core logic implementation, and release management. | 30%           |
...
| LAI U HIN       | Visual Designer & Media Producer          | Player asset creation, visual implementation in VS Code, and demo video production for validation.                 | 15%  
