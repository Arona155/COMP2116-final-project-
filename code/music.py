...
class SoundManager:
    ...
    def load_all_sounds(self):
        try:
            ...
            # 敵方子彈音效（新增）
            enemyshoot_path = resource_path("assets/sound/enemyshoot.wav")
            self.sounds["enemyshoot"] = pygame.mixer.Sound(str(enemyshoot_path))
            self.sounds["enemyshoot"].set_volume(0.1)
